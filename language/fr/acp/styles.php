...
$lang = array_merge($lang, [
	'ACP_STYLES_EXPLAIN'						=> 'Depuis cette page, vous pouvez gérer les styles disponibles sur votre forum.<br>Veuillez noter que vous ne pouvez pas désinstaller le style « <strong>prosilver</strong> », car il s’agit du style parent par défaut et principal de phpBB.<br> Veuillez consulter notre tutoriel pour la création d‘un <a href="https://forums.caforum.fr/viewtopic.php?t=22">style personnel</a>',
