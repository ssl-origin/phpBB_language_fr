...
$lang = array_merge($lang, array(
	...
	<ul>
		...
		<li>Le port du serveur de votre base de données (facultatif).</li>
...
$lang = array_merge($lang, array(
	...
	'UPDATE_INSTALLATION_EXPLAIN'	=> 'Avec cette option, il est possible de mettre à jour votre installation phpBB vers la dernière version.<br />Pendant le processus, tous vos fichiers seront vérifiés pour leur intégrité. Vous pouvez examiner toutes les différences et tous les fichiers avant la mise à jour.<br /><br />La mise à jour du fichier elle-même peut être effectuée de deux manières différentes.</p><h2>Mise à jour manuelle</h2><p>Avec cette mise à jour, vous ne téléchargez que votre ensemble personnel de fichiers modifiés pour vous assurer de ne pas perdre les modifications de fichiers que vous avez pu effectuer. Après avoir téléchargé ce package, vous devez télécharger manuellement les fichiers à leur position correcte sous votre répertoire racine phpBB. Une fois cela fait, vous pouvez refaire l‘étape de vérification des fichiers pour voir si vous avez déplacé les fichiers vers leur emplacement correct.</p><h2>Mise à jour avancée avec FTP</h2><p>Cette méthode est similaire à la première un mais sans avoir besoin de télécharger les fichiers modifiés et de les télécharger par vous-même. Cela sera fait pour vous. Pour utiliser cette méthode, vous devez connaître vos informations de connexion FTP car elles vous seront demandées. Une fois terminé, vous serez à nouveau redirigé vers la vérification des fichiers pour vous assurer que tout a été correctement mis à jour.<br /><br />',
	'UPDATE_INSTRUCTIONS'			=> '
		...
		</p>La méthode recommandée pour mettre à jour votre installation est d‘utiliser le pack complet. Si les principaux fichiers phpBB ont été modifiés dans votre installation, vous pouvez souhaiter utiliser le pack de mise à jour avancé afin de ne pas perdre ces changements. Vous pouvez également mettre à jour votre installation en utilisant les autres méthodes listées dans le document INSTALL.html. Les étapes de la mise à jour de phpBB3 à l‘aide du package complet sont :</p>
		...
		<h1>Comment mettre à jour votre installation avec le paquet de mise à jour avancée ?</h1>

		<p>Le paquet de mise à jour avancée est uniquement recommandé aux utilisateurs experts dans le cas où les fichiers de base de phpBB ont été modifiés dans votre installation. Vous pouvez également mettre à jour votre installation en utilisant les méthodes listées dans le document INSTALL.html. Les étapes de la mise à jour de phpBB3 à l‘aide du pack de mise à jour avancée sont les suivantes :</p>

		<ol style="margin-left: 20px; font-size: 1.1em;">
			<li>Allez sur la page <a href="https://www.phpbb.com/downloads/" title="https://www.phpbb.com/downloads/">page de téléchargement de phpBB.com</a> et téléchargez l‘archive "Advanced Update Package".</li>
			<li>Décompressez l’archive.</li>
		...
		<h1>Utilisateurs de la traduction de caforum-phpBB</h1>

		<p>Pour les administrateurs utilisant la traduction de caforum-phpBB, nous vous recommandons auparavant de consulter les liens suivants :</p>
		<ul style="margin-left: 20px; font-size: 1.1em;">
			<li><a href="https://forums.caforum.fr/viewtopic.php?t=769">Mise à jour en utilisant le système de fichiers modifiés (Changed files)</a>.</li>
			<li><a href="https://forums.caforum.fr/viewtopic.php?t=51">Mise à jour/Mise à niveau en utilisant le pack complet</a>.</li>
			<li><a href="https://forums.caforum.fr/viewforum.php?f=49" title="https://forums.caforum.fr/viewforum.php?f=49">Téléchargements : Pack complet (en anglais), Pack de langue française</a>.</li>
		</ul>

		<p>Vous trouverez également notre tutoriel pour mettre à jour vos <a href="https://forums.caforum.fr/viewtopic.php?t=167">styles personnels</a>.</p>		
	',
));
